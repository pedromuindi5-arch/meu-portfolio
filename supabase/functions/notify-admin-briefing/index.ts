      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;background:#0a0a0a;color:#fff;padding:32px;max-width:720px;margin:0 auto">
            ...
            <p style="font-size:12px;color:#666">O PDF completo das respostas está anexado a este email. O registo também está disponível no separador “Briefings” do painel administrativo.</p>
          </div>
        `,
